...
:point_right: 最新广州大学硕士学位论文模板，根据学校文件要求进行写作

- [《广州大学研究生学位论文格式要求.docx》](./images/广州大学研究生学位论文格式要求.docx)
- [《广州大学硕士学位论文扉页.docx》](./images/广州大学硕士学位论文扉页.docx)

:point_right: 完整示例论文可查看[论文示例](./main.pdf)，超低上手难度，章节明了，支持不同编译模式
